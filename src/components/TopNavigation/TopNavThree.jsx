...
function TopNavThree(props) {
    return (
        <Fragment>
            <header className="theme-main-menu sticky-menu theme-menu-three">
                <div className="inner-content">
                    <div className="container d-flex align-items-center justify-content-between">
                        <div className="logo order-lg-0"><a href="index.html" className="d-block"><img src={logo_02} alt="" width={129} /></a></div>
                        ...
                        <nav className="navbar navbar-expand-lg order-lg-2">
                            ...
                            <div className="collapse navbar-collapse" id="navbarNav">
                                <ul className="navbar-nav">
                                    <li className="d-block d-lg-none"><div className="logo"><a href="index.html"><img src={logo_02} alt="" width={130} /></a></div></li>
