            ...
            <header className="theme-main-menu sticky-menu theme-menu-two">
                <div className="inner-content">
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                <div className="right-widget d-flex align-items-center">
                                    <div className="lang-dropdown me-3 me-sm-4">
                                        <button className="dropdown-toggle" type="button" id="langDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
                                            Eng
                                        </button>
                                    ...
                                    <button className="menu-search-btn tran3s m0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><i className="bi bi-search" /></button>
                                </div> {/* /.right-widget */}
                            </div>
                        </div> {/* /.container */}
                    </div> {/* /.top-header */}
                    <div className="container d-flex align-items-center justify-content-between">
                        ...
                        <a href="contact-us.html" className="get-in-touch-btn d-none d-lg-block order-lg-3">Get In Touch</a>
