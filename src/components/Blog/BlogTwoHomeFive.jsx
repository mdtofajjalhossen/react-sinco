...
import blog_img_07 from '../../assets/images/blog/blog_img_07.jpg'
import blog_img_06 from '../../assets/images/blog/blog_img_06.jpg'
function BlogTwoHomeFive(props) {
    return (
        <Fragment>
                ...
                <div className="container">
                    ...
                    <div className="row gx-xxl-5">
                        ...
                        <div className="col-lg-4 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay={100}>
                            <article className="blog-meta-two mt-30">
                                <figure className="post-img m0"><a href="blog-details.html" className="w-100 d-block"><img src={blog_img_07} alt="" className="w-100 tran4s" /></a></figure>
                                <div className="post-data">
                                    <div className="post-tag"><a href="blog-details.html">23 Apr, 2021</a></div>
...
export default BlogTwoHomeFive;