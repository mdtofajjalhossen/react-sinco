...
function FeedbackThreeHomeFive(props) {
    var settings = {
        dots: true,
        slidesToShow: 1,
        slidesToScroll: 1,
    ...
    return (
        <Fragment>
            <div className="feedback-section-three style-two mt-180 lg-mt-120" data-aos="fade-up">
                <div className="container">
                    <div className="slider-wrapper">
                        <div className="feedback_slider_three">
                            <Slider {...settings}>
                            <div className="item">
                                <div className="feedback-block-three d-md-flex align-items-center">
...
export default FeedbackThreeHomeFive;